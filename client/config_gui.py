...
class backup_gui(Tkinter.Tk):
    ...
    def initialize(self):
        ...
        self.config_name_label = Tkinter.Label(self, text="Hostname: ").grid(column=0,row=0,sticky='EW')
        self.config_nameVariable = Tkinter.StringVar()
        self.config_name = Tkinter.Entry(self,textvariable=self.config_nameVariable)
        ...
        self.config_server_label = Tkinter.Label(self, text="Server: ").grid(column=0,row=1,sticky='EW')
        self.config_serverVariable = Tkinter.StringVar()
        self.config_server = Tkinter.Entry(self,textvariable=self.config_serverVariable)
        ...
        ### Configuration - Port ###
        self.config_port_label = Tkinter.Label(self, text="Port: ").grid(column=0,row=2,sticky='EW')
        self.config_portVariable = Tkinter.StringVar()
        self.config_port = Tkinter.Entry(self,textvariable=self.config_portVariable)
        ...
        self.config_password_label = Tkinter.Label(self, text="Password: ").grid(column=0,row=3,sticky='EW')
        self.config_passwordVariable = Tkinter.StringVar()
        self.config_password = Tkinter.Entry(self,show='*',textvariable=self.config_passwordVariable)
        ...
        configbutton = Tkinter.Button(self,text=u"Save Config",
                            command=self.ConfigOnButtonClick)
        configbutton.grid(column=1,row=8)
        
        ### Configuration - Retention ###
        self.config_retention_label = Tkinter.Label(self, text="Retention (Days): ").grid(column=0,row=4,sticky='EW')
        self.config_retentionVariable = Tkinter.StringVar()
        self.config_retention = Tkinter.Entry(self,textvariable=self.config_retentionVariable)
        ...
        self.config_nextrun_label = Tkinter.Label(self, text="Next Run: ").grid(column=0,row=5,sticky='EW')
        self.config_nextrunVariable = Tkinter.StringVar()
        self.config_nextrun = Tkinter.Label(self,textvariable=self.config_nextrunVariable)
        ...
        self.config_nextrunHour_label = Tkinter.Label(self, text="Hour: ").grid(column=0,row=6,sticky='EW')
        self.config_nextrunHourVariable = Tkinter.StringVar()
        self.config_nextrunHour = Tkinter.Entry(self,textvariable=self.config_nextrunHourVariable)
        ...
        self.config_nextrunMin_label = Tkinter.Label(self, text="Minute: ").grid(column=0,row=7,sticky='EW')
        self.config_nextrunMinVariable = Tkinter.StringVar()
        self.config_nextrunMin = Tkinter.Entry(self,textvariable=self.config_nextrunMinVariable)
        ...
        self.task_list = tk.Listbox(self, width=50, height=6)
        self.task_list.grid(row=8, column=4)

        # create a vertical scrollbar to the right of the listbox
        self.yscroll = tk.Scrollbar(command=self.task_list.yview, orient=tk.VERTICAL)
        self.yscroll.grid(row=8, column=5, sticky=tk.N+tk.S)
        self.task_list.configure(yscrollcommand=self.yscroll.set)
        
        ### Action - Upload ###
#        self.action_put_label = Tkinter.Label(self, text="File: ").grid(column=0,row=3,sticky='EW')
#        self.action_putVariable = Tkinter.StringVar()
#        self.action_put = Tkinter.Entry(self,textvariable=self.action_putVariable)
...
#        
#        action_put_button = Tkinter.Button(self,text=u"Upload",
#                              command=self.ActionPutOnButtonClick)
#        action_put_button.grid(column=2,row=3)

        # use entry widget to display/edit selection
        self.input = tk.Entry(self, width=50)
        ...
        self.button_enable_schedule = tk.Button(self, text=' Enable Schedule', command=self.enable_schedule)
        self.button_enable_schedule.grid(row=5, column=3, sticky=tk.E)
        
        self.button_disable_schedule = tk.Button(self, text='Disable Schedule', command=self.disable_schedule)
        self.button_disable_schedule.grid(row=6, column=3, sticky=tk.E)

        #This button is used to add tasks
        self.button_add_task = tk.Button(self, text='  Add ', command=self.new_task)
        self.button_add_task.grid(row=5, column=4, sticky=tk.E)

        #This Button is used to call the delete function
        self.button_delete = tk.Button(self, text='Delete', command=self.delete_item)
        self.button_delete.grid(row=7, column=4, sticky=tk.E)
        ...
        self.config_name.selection_range(0, Tkinter.END)
    ...
    def new_task(self):
        self.task_list.insert(tk.END, self.input.get())
    ...
    def save_tasks(self):
        ...
        temp_list = list(self.task_list.get(0, tk.END))
...
if __name__ == "__main__":
    ...
    task_list = tk.Listbox(app, width=50, height=6)
